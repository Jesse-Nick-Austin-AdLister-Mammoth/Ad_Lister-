...
VALUES (1, 'Codeup Coffee Mug',
  ...
  (1, 'Codeup Hoodie Sweatshirt',
   'Hoodies aren\'t just for sitting behind the desk anymore. The 100 percent cotton sweatshirt is formal enough to wear as your jacket to Black Tie event. But also casual enough for a night out on the town. You wont wont to leave this bad boy on the coat rack next time you head out.', null, 2),
